...
/>
    ...
    <div className="SignupScreen">
      ...
      <button 
        onClick={() => loginWithMail(credential.email, credential.password)}
      >
        Login
      </button>
                    ...
                    <Link className="SignupScreen__gray" style={{textDecoration:"none"}} to="/SignUpScreen">
                    New to 10452.lb?  Sign Up Now
                    </Link>
                    </span>
